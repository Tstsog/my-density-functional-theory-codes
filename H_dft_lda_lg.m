...
%
function [] = H_dft_lda_lg
%
clc; clear H_dft_lda_lg
format short 
%
Z = 1.;   % charge of hydrogen nucleus; 
...
%
    ...
    [En_1_2s, En_2_2s, En_3_2s, V1_2s, rho_2s_] = H_KS_eig_val(D2,wr,r,Z, 2.,0., Vpois_11,V_ex, n_xc.*V_corr); % 2s orbital - virtial 
    [En_1_2p, En_2_2p, En_3_2p, V1_2p, rho_2p_] = H_KS_eig_val(D2,wr,r,Z, 1.,1., Vpois_11,V_ex, n_xc.*V_corr); % 2p orbital - virtial    
    %
    rho_new = 1.*rho_1s_ + 0.*rho_2s_ + 0.*rho_2p_;
    %
...
%
En_total_gr_au = (1.*En_1_1s) - 0.5*Vee + En_xc ;
%
