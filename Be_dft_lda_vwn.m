% This matlab code computes the ground state energy of beryllium (Be) atom by
...
%
function [] = Be_dft_lda_vwn
%
clear; clc;
format long
%
clear; clc;
Z = 4.;   % charge of beryllium nucleus; 
...
%
En_total_gr_au = (2.*En_1s + 2.*En_2s) - 0.5*Z.*Vee + En_xc ;
%
[En_1s, En_2s, En_total_gr_au]
% [-3.856410611453637  -0.205743782270479 -14.447209474024008] vs
% [-3.856411,          -0.205744,         -14.447209] from https://www.nist.gov/pml/atomic-reference-data-electronic-structure-calculations/atomic-reference-data-electronic-7-3
%%%
