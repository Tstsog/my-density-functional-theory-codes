% This matlab code computes the ground state energy of boron (B) atom by
...
%
function [] = B_dft_lda_vwn
%
clear; clc;
format long
%
clear; clc;
Z = 5.;   % charge of berrylium nucleus; 
...
[En_1s, En_2s, En_2p];
%
rho_old = 2.*rho_1s + 2.*rho_2s + 1.*rho_2p; 
%
x_alpha = 3./4;
%
ac1 = 0.0621814/2;
...
%
    ...
    %
    rho_new = 2.*rho_1s_ + 2.*rho_2s_ + 1.*rho_2p_;
    %
...
%
En_total_gr_au = (2.*En_1s + 2.*En_2s + 1.*En_2p) - 0.5*Z.*Vee + En_xc ;
%
[En_1s, En_2s, En_2p, En_total_gr_au]
% [-6.564346883432478  -0.344700832869914  -0.136602982930907 -24.344198102788692] vs 
% [-6.564347,          -0.344701,          -0.136603,         -24.344198]
