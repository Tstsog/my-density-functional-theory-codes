...
%
En_total_gr_au = (2.*En_1s + 1.*En_2s) - 0.5*Z.*Vee + En_xc ;
%
[En_1s, En_2s, En_total_gr_au]
%[-1.878563764829083  -0.105539659927303  -7.335195188614042] vs
%[-1.878564,          -0.105540,          -7.335195] from https://www.nist.gov/pml/atomic-reference-data-electronic-structure-calculations/atomic-reference-data-electronic-7-2
%%%
