% This matlab code computes the ground state energy of lithium (Li) atom by
...
%
function [] = Li_dft_lsda_gl
%
clc; 
clear Li_dft_lsda_gl 
format short 
%
Z = 3.;   % charge of Helium nucleus; 
...
%    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
    %
    [En_1_1s_alpha, En_2_1s_alpha, En_3_1s_alpha, V1_1s, rho_1s_alpha] = H_KS_eig_val(D2,wr,r,Z, 1.,0., Vpois_11, V_xc_alpha); % 1s orbital 
    [En_1_2s_alpha, En_2_2s_alpha, En_3_2s_alpha, V1_2s, rho_2s_alpha] = H_KS_eig_val(D2,wr,r,Z, 2.,0., Vpois_11, V_xc_alpha); % 2s orbital
    [En_1_1s_beta,  En_2_1s_beta,  En_3_1s_beta,  V1_1s, rho_1s_beta] = H_KS_eig_val(D2,wr,r,Z, 1.,0., Vpois_11, V_xc_beta); % 1s orbital    
    %
    rho_alpha = rho_1s_alpha + rho_2s_alpha; 
...
[En_1_1s_alpha, En_2_2s_alpha, En_1_1s_beta]; % 
...
V_xc = V_xc_alpha + V_xc_beta;
%
Vee = sum(wr.*rho_1s_old.*Vpois_11.*r.*r.*4.*pi);
En_xc = sum(wr.*rho_1s_old.*eps_xc.*r.*r.*4.*pi);
%
En_total_gr_au = (En_1_1s_alpha + En_1_1s_beta + 1.*En_2_2s_alpha) - 0.5.*Vee + (En_xc - V_xc); % -7.383002777683643 
%
[En_1_1s_alpha, En_2_2s_alpha, En_1_1s_beta, En_total_gr_au]
% [-1.8861   -0.1242   -1.8778   -7.3830]
...
%%%
%%%
function [En_1, En_2, En_3, V1, rho_1s] = H_KS_eig_val(D2,wr,r,Z,eig_ind,ell,Vpois_11, V_xc)
%
%%%
